...
class VQG(nn.Module):
    ...
    def info_parameters(self):
        params = (list(self.mu_answer_encoder.parameters()) +
    ...
    def encode_into_z(self, image_features):
        ...
        """
        mus = self.mu_answer_encoder(image_features)
        logvars = self.logvar_answer_encoder(image_features)
        return mus, logvars
    ...
    def forward(self, images, alengths=None, questions=None,
        ...
        mus, logvars = self.encode_into_z(image_features)
    ...
    def predict_from_image(self, images,
        ...
        Returns:
            ...
            into the vocab word.
        """
        image_features, zs = self.encode_from_image(images)
