...
def evaluate(vqg, data_loader, vocab, args, params):
    ...
    for iterations, (images, questions, _) in enumerate(data_loader):
...
def main(args):
    ...
    vqg = VQG(len(vocab), params.max_length, params.hidden_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--from-image', type=str, default='true',
